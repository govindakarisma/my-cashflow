    ...
    <div class="card">
      <div class="card-body p-3">
        <div class="row">
          <div class="col-8">
            <div class="numbers">
              <p class="text-sm mb-0 text-uppercase font-weight-bold">Current Credit</p>
    ...
    <div class="card">
      <div class="card-body p-3">
        <div class="row">
          <div class="col-8">
            <div class="numbers">
              <p class="text-sm mb-0 text-uppercase font-weight-bold">Current Debit</p>
              <h5 class="font-weight-bolder">
                Rp9.750.000
              </h5>
              <p class="mb-0">
        ...
        <div class="row">
          <div class="col-8">
            <div class="numbers">
              ...
              <p class="mb-0">
                Today
                <span class="text-success text-sm font-weight-bolder">March, 15 2022</span>
              </p>
            </div>
          </div>
          <div class="col-4 text-end">
